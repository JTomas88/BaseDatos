...
{
function modificarRegistroEliminar (documentoLeido:string; personaAmodificar:TRegistroPersona;
...
begin
  ...
  nuevoRegistro.Eliminado:=registroValidado.Eliminado; {>> aqui sigue llegando a false}
